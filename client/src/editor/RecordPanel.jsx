            ...
            [0, 1, 2].map((i) => (
              ...
              >
                ...
                <div className="record-item-content">
                  ...
                  <span
                    className="record-item-subtitle"
                    style={{
                      background: "#f3f3f3",
                      borderRadius: 4,
                      color: "transparent",
  ...
  return (
    <div className="library_main">
      <div style={{ padding: "0 8px", marginBottom: "24px" }}>
        <h2 style={{ fontSize: "18px", fontWeight: "900", color: "#111" }}>
          Library
        </h2>
        <p style={{ fontSize: "11px", color: "#6B7280", marginTop: "-8px" }}>
          Saved environments & models
        </p>
      </div>
