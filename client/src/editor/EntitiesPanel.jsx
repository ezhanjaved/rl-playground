  ...
  const agents = [
    ...
    },
    {
      ...
      payload: {
        ...
        behavior: [
          { type: "Collect", requiredCount: 20, status: false },
    ...
    },
    {
      ...
      payload: {
        ...
        behavior: [
          { type: "Destroy", requiredCount: 20, status: false },
    ...
    },
    {
      ...
      payload: {
        ...
        behavior: [
          ...
          { type: "Deposit", requiredCount: 4, status: false },
          { type: "Destroy", requiredCount: 1, status: false },
          { type: "Open", requiredCount: 1, status: false },
          { type: "Find", requiredCount: 1, status: false },
        ],
    ...
    },
    {
      ...
      payload: {
        ...
        behavior: [
          { type: "Collect", requiredCount: 2, status: false },
          { type: "Open", requiredCount: 1, status: false },
          { type: "Collect", requiredCount: 4, status: false },
          { type: "Destroy", requiredCount: 1, status: false },
          { type: "Deposit", requiredCount: 1, status: false },
          { type: "Find", requiredCount: 1, status: false },
        ],
    ...
    },
    {
      ...
      payload: {
        ...
        behavior: [
          { type: "Destroy", requiredCount: 3, status: false },
  ...
  const nonStateObjects = [
    ...
    },
    {
      ...
      payload: {
        ...
        collider: { shape: "capsule", h: 1, r: 0.0 },
      },
    },
    {
