...
export default function EntitiesPanel() {
    ...
    const pickableItems = [
        ...
        { id: "lib_pickable_obj_5", image: pick5, payload: { name: "Key", tag: "Pickable Object", isDecor: "false", isPickable: "true", isCollectable: "true", assetRef: "resources/key.gltf", collider: { shape: "capsule", h: 1, r: 0.2 }, targetStat: {radius: 1} } },
        { id: "lib_pickable_obj_6", image: pick6, payload: { name: "Coin", tag: "Pickable Object", isDecor: "false", isPickable: "true", isCollectable: "true", assetRef: "resources/coin.gltf", collider: { shape: "capsule", h: 1, r: 0.2 }, targetStat: {radius: 1} } }
    ]
