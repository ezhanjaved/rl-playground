...
const RecordPage = () => {
    ...
    const data = [
        { id: 'm1', name: 'Robot Runner v1', env: 'Warehouse-Alpha', status: 'Trained', date: '2026-03-15' },
        { id: 'm2', name: 'Drone Scout', env: 'Forest-X', status: 'Training', date: 'In Progress' },
        { id: 'm3', name: 'Car Navigator', env: 'City-Grid', status: 'Trained', date: '2026-04-01' },
        { id: 'm4', name: 'Arm Manipulator', env: 'Factory-Floor', status: 'Trained', date: '2026-04-03' },
    ];
            ...
            <main className="dashboard-main">
                <div style={{ maxWidth: '1152px', margin: '0 auto' }}>
                    <header className="dashboard-header">
                        ...
                        <p className="dashboard-subtitle">Central hub for your training sessions and environment snapshots.</p>
                    </header>
